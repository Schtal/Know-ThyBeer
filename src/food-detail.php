<?php 
    $title = "Conheça os detalhes deste prato";
 ?>
        ...
        <div class="container-fluid background-yellow" id="main-content">
            ...
            <?php include "header.php" ?>
                ...
                <div class="row" id="content-body">
                    <div class="col">
                        <div class="row">
                            <div class="col-sm-12 col-md4"> <a href="javascript:void(0)" onclick="toggleFavoritar('comida')" > <span id="favorito" class="fa fa-star"></span> </a></div>
